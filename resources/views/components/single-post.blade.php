                ...
                <x-panel>
                    <form action="/posts/{{ $post->slug; }}/comments" method="post">
                        ...
                        <div class="flex justify-end mt-5">
                            <button type="submit" class="bg-blue-400 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl hover:bg-blue-600">Post</button>
                        </div>
                    </form>
                </x-panel>
            @else
            <p class="text-sm">
                <a href="/register" class="text-blue-500 font-bold hover:text-blue-600">Register </a>or <a href="/login" class="text-blue-500 font-bold">Log in</a> to comment.
            </p>
